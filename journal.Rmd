...
# Challenge 2
   ...
   For the challenge a) I am going use Rick and Morty API from https://rickandmortyapi.com.
...
# #url <- httr::GET("https://rickandmortyapi.com/api/")
# 
# rick_and_morty <- function(path) {
#   url <- modify_url(url = "https://rickandmortyapi.com/api/", path = glue("/api{path}"))
#   resp <- GET(url)
#   stop_for_status(resp)
# }
# rawToChar(rick_and_morty(character/1)) %>%
#   jsonlite::fromJSON()



```
```{r, code=readLines("./Data_Acquisition_Challenge_1.R")}
```
